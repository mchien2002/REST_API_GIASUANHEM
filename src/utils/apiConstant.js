const LIST_NEWCLASS = "/new_class/index";
const LIST_POST = "/post/index";
const LIST_CLASS = "/class/index";
...
const NEWCLASS_UPDATE = "/new_class/edit";
const CATEGORY_UPDATE = "/category/edit";
const CLASS_UPDATE = "/class/edit";
const SUBJECT_UPDATE = "/subject/edit";
const POST_UPDATE = "/post/edit";
const TUTOR_UPDATE = "/tutor/edit";
...
module.exports = routes = { LIST_NEWCLASS, LIST_POST, LIST_CLASS, LIST_SUBJECT, LIST_ACCOUNT, LIST_CATEGORY, NEWCLASS_UPDATE_STATUS, LIST_TUTOR, CLASS_REMOVE, CHECK_LOGIN, NEWCLASS_REMOVE, TUTOR_REMOVE, SUBJECT_REMOVE, CATEGORY_REMOVE, NEWCLASS_UPDATE, CATEGORY_UPDATE, CLASS_UPDATE, SUBJECT_UPDATE, POST_UPDATE, TUTOR_UPDATE, POST_REMOVE, LIST_SALARYINFO, SALARYINFO_REMOVE, SALARYINFO_UPDATE, NEWCLASS_FILTER, LIST_TRANSACTION, GET_ADMIN, CATEGORY_BY_ID, TUTOR_BY_ID }
